...
<title>Smartooth 모니터링 페이지 :: 로그인</title>
...
<body>
  <div class="container">
  	...
  	<div>
  		<div class="jumbotron">
  			<form method="post" id="frm" action="/premium/statistics/login.do?schoolCode=KG0001">
  				...
  				<div class="form-group">
  					<input type="password" class="form-control" placeholder="비밀번호" id="userPwd"  name="userPwd" maxlength="20">
  				</div>
