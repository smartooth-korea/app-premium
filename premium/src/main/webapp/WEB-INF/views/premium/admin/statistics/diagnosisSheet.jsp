...
<style type="text/css">
	...
	<div class="menu">
		<img id="diagnosis_data_btn" class="menu-btn" src="/imgs/layout/btn/diagnosis_data_btn_enabled.png" style="width: 170px;">
		<img id="diagnosis_graph_btn" class="menu-btn" sr c="/imgs/layout/btn/diagnosis_graph_btn_disabled.png" style="width: 170px;">
	</div>
...
<!-- 	<button id="btn_editTextarea" style="margin-left: 10px; height: 36px;"><b>등록</b></button> -->
...
<script src="js/premium/admin/statistics/diagnosis.js"></script>
...
$(document).ready(function() {
	...
	dataList.push({
		...
		// 영구치
		,t86:"${dataList.t30}"
		,cavityNormal:"${dataList.cavityNormal}"
		,cavityCaution:"${dataList.cavityCaution}"
		,cavityDanger:"${dataList.cavityDanger}"
		,memo:"${dataList.memo}"	
	...
	// 	치아 색상 변경		
	changeToothColorByLevel(dataList, index, caution, danger);
	...
	$("#btn_downloadImg").click(function(e){
        ...
        // html2canvas(document.body).then(function(canvas) {
            ...
            el.download = schoolName+'_'+className+'_'+userName+'_'+measureDt+'.jpg'; //다운로드 할 파일명 설정
            el.click();
        });
    });
