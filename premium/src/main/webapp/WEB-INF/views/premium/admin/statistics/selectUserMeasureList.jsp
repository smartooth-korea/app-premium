...
<!-- Page Wrapper -->
   	<div id="wrapper">
		<jsp:include page="/WEB-INF/views/premium/admin/layout/left.jsp"></jsp:include>
<!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
<!-- Body-->
            <div id="content">
<!-- Top menu -->
			<jsp:include page="/WEB-INF/views/premium/admin/layout/header.jsp"></jsp:include>
<!-- Contents -->
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body organList">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-file fa-2x text-gray-333"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- Footer menu -->
			<jsp:include page="/WEB-INF/views/premium/admin/layout/footer.jsp"></jsp:include>
		</div>
	</div>
...
$(document).ready(function(){
	...
	$("#grid").jqGrid({
		url : "/premium/admin/user/selectUserMeasureList.do",
		datatype : "json",
		styleUI: 'Foundation',
...
// 						}
		...
		ondblClickRow : function(rowId, iRow, iCol, e){ 
			...
			var url = '/premium/admin/statistics/diagnosisSheetPopup?userId='+userId+'&userName='+userName+'&measureDt='+measureDt+'&schoolName='+schoolName+'&className='+className;
