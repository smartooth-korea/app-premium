...
<title>㈜스마트코리아 기관 조회/수정/삭제 ::: main</title>
<!-- favicon ico 에러 -->
...
<%--                         <h1 class="h3 mb-0 text-gray-800">${userInfo.classDepth}</h1> --%>
...
$(document).ready(function(){
	...
	$("#grid").jqGrid({
		url : "/premium/admin/organ/selectOrganList.do",
		datatype : "json",
		styleUI: 'Foundation',
		...
		colModel: [
						...
						,{
							name:'EUPMYEONDONG_NM',
							index:'EUPMYEONDONG_NM',
							width:'25%',
							align:'center',
						}
					],
